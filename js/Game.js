class Game {
  ...
  start() {
    ...
    fuel = new Group();
    powerCoin = new Group();
    this.addSprite(fuel,4, fuelImage, 0.02);
    this.addSprite(powerCoin, 18, powerCoinImage, 0.08);
  }

  addSprite(spriteGroup, noSprites, spriteImg, scale){
    for(var i = 0; i<noSprites; i+=1){
